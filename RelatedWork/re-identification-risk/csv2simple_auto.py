...
path_data_export = 'master-thesis/results/'
...
attributes = ['case:Diagnosis', 'case:Age', 'case:Diagnosis code', 'case:Specialism code', 'case:Diagnosis Treatment Combination ID', 'case:Treatment code', 'case:Start date', 'time:timestamp', 'Activity code', 'concept:name']
...
df_data = pd.read_csv(filepath_or_buffer=path_data_sources + csv_source_file_name, delimiter=csv_delimiter, low_memory=False)
if not attributes:
